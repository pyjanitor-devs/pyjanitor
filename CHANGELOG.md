...
- [ENH] Improvements to `pivot_longer` function, with improved speed and cleaner code.`dtypes` parameter dropped; user can change dtypes with pandas' `astype` method, or
...
.. \_here: [https://github.com/ericmjl/pyjanitor/pulls?q=is%3Apr+is%3Aclosed](https://github.com/ericmjl/pyjanitor/pulls?q=is%3Apr+is%3Aclosed)
