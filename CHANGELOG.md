...
-   [ENH] Performance improvement for range joins in `conditional_join`, when `use_numba = False`. Performance improvement for equi-join, when `use_numba = True`, for many to many join with wide ranges. PR #1256, #1267 @samukweku
