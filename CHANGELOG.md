...
-   [TST] Rename `tests/utils/test_select_column.py` → `tests/utils/test_select_column.py` and update `functions/utils.py::_select_column_names` testcase. PR #1152 @Zeroto521
