...
This method modifies a column of floats to a nearest fraction,
given a certain denominator.
...
The denominator of the fraction to round to.
For example, `2` would round values to the nearest half (i.e. `1/2`).
...
## Example 3: Rounding to the nearest third with decimal places
