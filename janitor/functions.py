...
@pf.register_dataframe_method
def bin_numeric(
    df: pd.DataFrame, from_column: str, to_column: str, bins=None, labels=None
):
    """
    Three ways users can bins numeric columns into categorical columns:
    1. provide number of bins, returns bins grouped into quartiles,
    leave labels blank
    2. provide list of integers to be bined, which returns the numeric
    range of specified bins, leave labels blank
    3. provide interger or list per 1 & 2 and labels, which returns labels
    instead of range of values
