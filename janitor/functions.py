...
def conditional_join(
    ...
    *conditions,
    ...
    (df, right, conditions, how) = _conditional_join_preliminary_checks(
        df, right, conditions, how
    )

    return _conditional_join_compute(df, right, conditions, how)
