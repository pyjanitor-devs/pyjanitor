...
def test_df_MultiIndex(multiIndex_df, right_df):
    ...
    with pytest.raises(
        ...
        multiIndex_df.ge_join(right_df, "col_a", "col_a")
...
def test_right_MultiIndex(left_df, multiIndex_df):
    ...
    with pytest.raises(
        ...
        left_df.ge_join(multiIndex_df, "col_a", "col_a")
...
def test_wrong_length_suffixes(left_df, right_df):
    ...
    with pytest.raises(
        ...
        left_df.ge_join(right_df, "col_a", "col_a", suffixes=("_x",))
...
def test_suffixes_None(left_df, right_df):
    ...
    with pytest.raises(
        ...
        left_df.ge_join(right_df, "col_a", "col_a", suffixes=(None, None))
...
def test_wrong_type_suffix(left_df, right_df):
    ...
    """
    with pytest.raises(TypeError):
        left_df.ge_join(right_df, "col_a", "col_a", suffixes=("_x", 1))
...
def test_suffix_already_exists_df(left_df, right_df):
    ...
    left_df["col_a_x"] = 2
    with pytest.raises(ValueError):
        left_df.ge_join(right_df, "col_a", "col_a")
...
def test_column_same_type(left_df, right_df):
    ...
    with pytest.raises(ValueError):
        left_df.ge_join(right_df, "col_a", "col_c")
